...
// No FELT here any more. The web's `--ct-felt` baize was ported as a panel
// behind each slot's cards; the web's own mobile board never drew one — its
// slots sit straight on the page — and neither do we now. The cards are the
// object; a coloured rectangle around them was a frame competing with the
// picture, and it needed a light variant and a dark one to not be wrong in
// half the themes. Nothing beats them being on the page.
