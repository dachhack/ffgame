...
writeFileSync(new URL('../../packages/core/src/data/realWeeks.ts', here),
...
writeFileSync(new URL('../../packages/core/src/data/bakedSlugs.ts', here),
  '// AUTO-GENERATED by scripts/pbp/genRealPbp.mjs — do not edit by hand.\n' +
...
writeFileSync(new URL('../../packages/core/src/data/sleeperSlug.ts', here),
  '// AUTO-GENERATED by scripts/pbp/genRealPbp.mjs — do not edit by hand.\n' +
