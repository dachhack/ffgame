...
export const METRICS: Record<Pos, Metric[]> = {
  ...
  RB: [
    ...
    { id: 'underdog', name: 'Underdog', tag: 'COMEBACK', fx: 'streak', sc: '0.1 / yd + 6 / TD', ef: 'The comeback metric: flat rushing points, but while you’re TRAILING in the slot every score banks ×1.5. Fall behind and you punch above your weight to claw back; pull ahead and the boost switches off — no running up the score. Anti-snowball: it rewards being the underdog.' },
  ...
  WR: [
    ...
    { id: 'td', name: 'Touchdowns', tag: 'NUKE', fx: 'nuke', sc: '0.04 / yd + 10 / TD', ef: 'Boom-or-bust: scrimmage yards at a discount (0.04/yd) plus a big 10 per TD — and each TD wipes the opponent’s entire banked score AND steals a quarter of it.' },
    { id: 'underdog', name: 'Underdog', tag: 'COMEBACK', fx: 'streak', sc: '0.1 / yd + 6 / TD', ef: 'The comeback metric: flat receiving points, but while you’re TRAILING in the slot every score banks ×1.5. Fall behind and you punch above your weight to claw back; pull ahead and the boost switches off — no running up the score. Anti-snowball: it rewards being the underdog.' },
