...
export const METRICS: Record<Pos, Metric[]> = {
  ...
  RB: [
    ...
    { id: 'retyd', name: 'Return Yards', tag: 'DRIP', fx: 'sys', sc: '0.01 / yd → rate (pts/min)', ef: 'Unlock (1 wk): this player’s real kick + punt return yards feed a drip rate (yds × 0.01 pts/min) that accrues while your team has the ball. Same pauses/erases as a normal drip; 3 straight returns of 10+ yds goes hot → drip doubles, a short return cools it.', lock: 'unlock-return' },
  ],
  WR: [
