...
(`.ct-float`: 64px wide, taller card, −16px vertical overhang AND a −24px
outer-side poke past the strip edge into the felt margin; ≤600px: 54px,
−10px/−9px). The strip's
