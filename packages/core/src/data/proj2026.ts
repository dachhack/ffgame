...
/** Live StatHead pool, pulled 2026-08-22T14:09:09Z (445 skill players + games + sleeper ids; K/DST rows from the pull are dropped — kicker/DST projections ride the v0.311.0 team-id mechanism, not player slugs). */
export const PROJ_AS_OF = '2026-08-22';

const PROJ_CSV = `Jahmyr Gibbs,RB,26,17,9221
Jonathan Taylor,RB,24.65,17,6813
...
James Cook III,RB,16.88,17,8138
...
Javonte Williams,RB,17.25,16,7588
...
TreVeyon Henderson,RB,15.24,17,12529
Saquon Barkley,RB,16.06,16,4866
Kenneth Walker,RB,15.06,17,8151
...
Kyren Williams,RB,14.65,17,8150
...
Omarion Hampton,RB,16,15,12507
...
A.J. Brown,WR,15.60,15,5859
Lamar Jackson,QB,16.57,14,4881
Cam Skattebo,RB,16.57,14,12481
...
Tyler Warren,TE,13.18,17,12518
...
Rhamondre Stevenson,RB,12.27,15,7611
...
Jayden Higgins,WR,8.82,17,12484
Pat Freiermuth,TE,9.93,15,7600
Tyler Allgeier,RB,8.53,17,8132
Michael Wilson,WR,8.53,17,10232
Alec Pierce,WR,9.53,15,8142
...
Chris Rodriguez Jr.,RB,8.50,14,10219
...
Emari Demercado,RB,8.07,14,11199
...
Anthony Gould,WR,2.46,13,11762
...
Tahj Brooks,RB,1.50,14,12543
Raheim Sanders,RB,2.33,9,12472
Jaret Patterson,RB,2.10,10,7537
