...
export const POWERUPS: Powerup[] = [
  ...
  { id: 'extra-slot', name: 'Extra Slot', blurb: 'Add a slot to any window — for you AND your opponent. Must be applied before any window starts.', kind: 'action', timing: 'pre', price: 80, icon: '➕', target: 'window' },
  ...
  { id: 'unlock-underdog', name: 'Underdog', blurb: 'Attach to one of your slots before its window kicks off: he keeps his chosen metric, and while he’s TRAILING his head-to-head every score he banks counts ×1.5. Comeback fuel — pull ahead and the boost switches off. Best on a player you EXPECT to trail.', kind: 'action', timing: 'pre', price: 35, icon: '🐕', target: 'slot-you' },
