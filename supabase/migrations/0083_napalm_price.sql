-- 0083: NAPALM price ◎60. A live opponent-slot play: for the next 10 game-minutes,
-- any time the opponent's drip runs HOT it BURNS — the hot accrual goes negative
-- and bleeds their bank (floored at 0) instead of doubling it. Does nothing while
-- they stay cool, so it's a punish on a rival running too hot. Priced alongside
-- Cold Snap (60). Kept in lockstep with src/data/powerups.ts by
