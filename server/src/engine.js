...
import { resolveClassicMatchup, CLASSIC_WIN } from '../../packages/core/src/engine/classic.ts';
...
export { clearSyntheticWeeks, resolveLiveMatchup, aiLiveBuffs, resolveClassicMatchup, CLASSIC_WIN };
